...
from resources.lib.pages import animixplay, nyaa, animetosho, nekobt, torrentio, debrid_cloudfiles, easynews, animepahe, anikoto, hianime, watchnixtoons2, localfiles
