...
from resources.lib.pages import nyaa, animetosho, debrid_cloudfiles, aniwave, animepahe, hianime, gogoanime, watchnixtoons2, localfiles
...
class Sources(GetSources):
    def __init__(self, xml_file, location, actionArgs=None):
        ...
        self.embedProviders = ['animepahe', 'aniwave', 'gogo', 'hianime', 'watchnixtoons2']
